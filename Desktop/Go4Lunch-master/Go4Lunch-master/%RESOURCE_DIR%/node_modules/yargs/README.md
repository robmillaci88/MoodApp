...
Given a key, or an array of keys, pojoPlaces options under an alternative heading
...
- `group`: string, when displaying usage instructions pojoPlace the option under an alternative group heading, see [`group()`](#group)
